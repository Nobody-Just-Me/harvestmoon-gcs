...
public sealed partial class ModernSidebar : UserControl
{
    ...
    private void UpdateActiveDot(Button button, double opacity)
    {
        ...
        else if (button == TrackerNavButton) TrackerActiveDot.Opacity = opacity;
        else if (button == CalibrateNavButton) CalibrateActiveDot.Opacity = opacity;
        ...
        else if (button == FlightClassicNavButton) FlightClassicActiveDot.Opacity = opacity;
        else if (button == ClassicMapNavButton) ClassicMapActiveDot.Opacity = opacity;
        else if (button == TlogPlayerNavButton) TlogPlayerActiveDot.Opacity = opacity;
        else if (button == ParameterLegacyNavButton) ParameterLegacyActiveDot.Opacity = opacity;
        else if (button == DiagnosticsNavButton) DiagnosticsActiveDot.Opacity = opacity;
        else if (button == ThemeNavButton) ThemeActiveDot.Opacity = opacity;
#if !__WASM__
    ...
    private Brush GetActiveBorderBrushForButton(Button button)
    {
        ...
        if (button == TrackerNavButton) return (Brush)Application.Current.Resources["NavDiagnosticsBrush"];
        if (button == CalibrateNavButton) return (Brush)Application.Current.Resources["NavCalibrateBrush"];
        ...
        if (button == FlightClassicNavButton) return (Brush)Application.Current.Resources["NavFlightBrush"];
        if (button == ClassicMapNavButton) return (Brush)Application.Current.Resources["NavMapBrush"];
        if (button == TlogPlayerNavButton) return (Brush)Application.Current.Resources["NavTlogBrush"];
        if (button == ParameterLegacyNavButton) return (Brush)Application.Current.Resources["NavParameterBrush"];
        if (button == DiagnosticsNavButton) return (Brush)Application.Current.Resources["NavDiagnosticsBrush"];
        if (button == ThemeNavButton) return (Brush)Application.Current.Resources["NavThemeBrush"];
#if !__WASM__
