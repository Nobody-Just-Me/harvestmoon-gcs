...
public sealed partial class MainPage_Modern : Page
{
    ...
    private void OnTelemetryReceived(object? sender, Pigeon_Uno.Models.FlightData data)
    {
        ...
        bool isArmed = data.FlightMode != Pigeon_Uno.Core.Models.FlightMode.DISARMED;
