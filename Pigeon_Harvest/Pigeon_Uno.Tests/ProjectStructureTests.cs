...
public class ProjectStructureTests
{
    ...
    public void ProjectReferences_CoreProjectIsReferenced()
    {
        ...
        var coreAssembly = referencedAssemblies
            .FirstOrDefault(a => a.Name == "Pigeon_Uno.Core");

        // Assert
        coreAssembly.Should().NotBeNull("Test project should reference Pigeon_Uno.Core");
    }
    ...
    public void ProjectReferences_CoreProjectCanBeLoaded()
    {
        ...
        Action loadAction = () =>
        {
            coreAssembly = Assembly.Load("Pigeon_Uno.Core");
        };

        // Assert
        loadAction.Should().NotThrow("Pigeon_Uno.Core assembly should be loadable");
    ...
    {
        // Arrange
        var projectPath = FindProjectFile("Pigeon_Uno.csproj");
        ...
        else
        {
            ...
            var assembly = Assembly.Load("Pigeon_Uno.Core");
    ...
    {
        // Arrange
        var projectPath = FindProjectFile("Pigeon_Uno.Core.csproj");
    ...
    {
        // Arrange
        var coreAssembly = Assembly.Load("Pigeon_Uno.Core");

        // Act
        var loggingServiceType = coreAssembly.GetType("Pigeon_Uno.Core.Services.ILoggingService");
    ...
    public void CoreServices_SettingsServiceInterfaceExists()
    {
        ...
        // Act
        var settingsServiceType = coreAssembly.GetType("Pigeon_Uno.Core.Services.ISettingsService");
    ...
    public void CoreServices_GeofenceServiceInterfaceExists()
    {
        ...
        // Act
        var geofenceServiceType = coreAssembly.GetType("Pigeon_Uno.Core.Services.IGeofenceService");
    ...
    public void CoreModels_FlightDataModelExists()
    {
        ...
        // Act
        var flightDataType = coreAssembly.GetType("Pigeon_Uno.Core.Models.FlightData")
            ?? coreAssembly.GetType("Pigeon_Uno.Models.FlightData");
    ...
    public void CoreModels_GPSDataModelExists()
    {
        ...
        // Act
        var gpsDataType = coreAssembly.GetType("Pigeon_Uno.Core.Models.GPSData")
            ?? coreAssembly.GetType("Pigeon_Uno.Models.GPSData");
    ...
    public void CoreModels_WaypointModelExists()
    {
        ...
        // Act
        var waypointType = coreAssembly.GetType("Pigeon_Uno.Core.Models.Waypoint")
            ?? coreAssembly.GetType("Pigeon_Uno.Models.Waypoint");
    ...
    private string? FindProjectFile(string fileName)
    {
        ...
        {
            // Look for the project file in Pigeon_Uno directory
            var pigeonUnoDir = Path.Combine(currentDir, "Pigeon_Uno");
            ...
            // Look for the project file in Pigeon_Uno.Core directory
            var coreDir = Path.Combine(currentDir, "Pigeon_Uno.Core");
    ...
    private class MockGeofenceService : IGeofenceService
    {
        ...
        public void SetGeofenceType(Pigeon_Uno.Core.Models.GeofenceType type)
        {
            _data.Type = type;
        }
        ...
        {
            _data.Vertices.Add(new Pigeon_Uno.Core.Models.GeofenceVertex(_data.Vertices.Count, latitude, longitude));
        }
