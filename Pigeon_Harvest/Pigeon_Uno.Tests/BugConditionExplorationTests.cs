...
public class BugConditionExplorationTests
{
    ...
    public void Bug2_RefreshPorts_ShouldUseSerialPortHelper_NotGetPortNames()
    {
        ...
        var helperPorts = Pigeon_Uno.Core.Helpers.SerialPortHelper.GetAvailablePorts();
    ...
    public void Bug3_SerialPortHelper_IsNotCached_ReturnsCurrentStateEachCall()
    {
        ...
        var ports1 = Pigeon_Uno.Core.Helpers.SerialPortHelper.GetAvailablePorts();
        var ports2 = Pigeon_Uno.Core.Helpers.SerialPortHelper.GetAvailablePorts();
